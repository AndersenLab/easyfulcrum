...
proc_img_dir <- rprojroot::find_package_root_file("vignettes", "2020JanuaryHawaii_photos")
```
...
The `joinGenoFulc` function will process the raw sample photos and add information regarding them to the final data frame of data. Setting the `CeNDR` option to `TRUE` will place CeNDR criteria meeting photos in an appropriate subfolder.
