...
Nematode collections are performed following a detailed protocol found here **link**. The `easyfulcrum` package is written to process and analyze the data generated for a specific collection project. 

![File name convention](.FileNaming.png)
